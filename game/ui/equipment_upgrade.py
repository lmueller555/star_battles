...
EQUIPMENT_UPGRADE_SPECS: Dict[str, EquipmentUpgradeSpec] = {
    ...
    "line_hull_plating": EquipmentUpgradeSpec(
        item_id="line_hull_plating",
        name="Line Hull Plating",
        slot="hull",
        effect="Line hull reinforcement scaling maximum hit points per level.",
        level_cap=15,
        upgrade_axes=('hull_hp',),
        curves={
            "hull_hp": _linear(350.0, 35.0),
            "acceleration": _linear(-0.05, 0.0),
            "turn_accel": _linear(-0.2, 0.0),
            "durability": _linear(42000.0, 0.0),
        },
        steps=_hull_steps(1700.0, 360.0),
    ),
    "line_armor_plating": EquipmentUpgradeSpec(
        item_id="line_armor_plating",
        name="Line Armor Plating",
        slot="hull",
        effect="Armor-focused Line plating scaling mitigation at steady penalties.",
        level_cap=15,
        upgrade_axes=('armor',),
        curves={
            "armor": _linear(3.5, 0.35),
            "acceleration": _linear(-0.1, 0.0),
            "turn_accel": _linear(-0.1, 0.0),
            "durability": _linear(42000.0, 0.0),
        },
        steps=_hull_steps(1700.0, 360.0),
    ),
    "line_ht_plating": EquipmentUpgradeSpec(
        item_id="line_ht_plating",
        name="Line HT Plating",
        slot="hull",
        effect="Heavy-tuned plating scaling critical defense for Line ships.",
        level_cap=15,
        upgrade_axes=('critical_defense',),
        curves={
            "critical_defense": _linear(7.5, 0.75),
    ...
    "line_composite_plating": EquipmentUpgradeSpec(
        item_id="line_composite_plating",
        name="Line Composite Plating",
        slot="hull",
        effect="Composite plating scaling both armor and hull for Line ships.",
        level_cap=15,
        upgrade_axes=('armor', 'hull_hp'),
        curves={
            "armor": _linear(1.75, 0.17500000000000002),
            "hull_hp": _linear(175.0, 17.5),
            "acceleration": _linear(-0.08, 0.0),
            "turn_accel": _linear(-0.15, 0.0),
            "durability": _linear(42000.0, 0.0),
        },
        steps=_hull_steps(1700.0, 360.0),
    ),
    "line_ht_hull_plating": EquipmentUpgradeSpec(
        item_id="line_ht_hull_plating",
        name="Line HT Hull Plating",
        slot="hull",
        effect="Heavy-tuned hull reinforcement scaling crit defense and hull.",
        level_cap=15,
        upgrade_axes=('critical_defense', 'hull_hp'),
        curves={
            "critical_defense": _linear(2.5, 0.25),
            "hull_hp": _linear(233.33333333333334, 23.333333333333332),
            "acceleration": _linear(-0.03, 0.0),
            "turn_accel": _linear(-0.13, 0.0),
            "durability": _linear(42000.0, 0.0),
        },
        steps=_hull_steps(1700.0, 360.0),
    ),
    "line_ht_armor_plating": EquipmentUpgradeSpec(
        item_id="line_ht_armor_plating",
        name="Line HT Armor Plating",
        slot="hull",
        effect="Heavy-tuned armor scaling armor value and critical defense.",
        level_cap=15,
        upgrade_axes=('armor', 'critical_defense'),
        curves={
            "armor": _linear(2.3333333333333335, 0.2333333333333333),
            "critical_defense": _linear(2.5, 0.25),
            "acceleration": _linear(-0.07, 0.0),
            "turn_accel": _linear(-0.07, 0.0),
            "durability": _linear(42000.0, 0.0),
        },
        steps=_hull_steps(1700.0, 360.0),
    ),
    "line_ht_composite_plating": EquipmentUpgradeSpec(
        item_id="line_ht_composite_plating",
        name="Line HT Composite Plating",
        slot="hull",
        effect="Heavy-tuned composite scaling armor, crit defense, and hull capacity.",
        level_cap=15,
        upgrade_axes=('armor', 'critical_defense', 'hull_hp'),
        curves={
            "armor": _linear(1.4, 0.14),
            "critical_defense": _linear(1.5, 0.15),
            "hull_hp": _linear(140.0, 14.0),
            "acceleration": _linear(-0.05, 0.0),
            "turn_accel": _linear(-0.1, 0.0),
            "durability": _linear(42000.0, 0.0),
        },
    ...
    "escort_composite_plating": EquipmentUpgradeSpec(
        item_id="escort_composite_plating",
        name="Escort Composite Plating",
        slot="hull",
        effect="Composite Escort plating scaling armor and hull buffers.",
        level_cap=15,
        upgrade_axes=('armor', 'hull_hp'),
        curves={
            "armor": _linear(2.13, 0.21214285714285716),
            "hull_hp": _linear(82.5, 8.25),
            "acceleration": _linear(-0.15, 0.0),
            "turn_accel": _linear(-0.38, 0.0),
            "durability": _linear(18000.0, 0.0),
        },
        steps=_hull_steps(1275.0, 270.0),
    ),
    "escort_hull_plating": EquipmentUpgradeSpec(
        item_id="escort_hull_plating",
        name="Escort Hull Plating",
        slot="hull",
        effect="Escort hull reinforcement scaling maximum hull points.",
        level_cap=15,
        upgrade_axes=('hull_hp',),
        curves={
            "hull_hp": _linear(165.0, 16.5),
            "acceleration": _linear(-0.1, 0.0),
            "turn_accel": _linear(-0.5, 0.0),
            "durability": _linear(18000.0, 0.0),
        },
    ...
    "escort_armor_plating": EquipmentUpgradeSpec(
        item_id="escort_armor_plating",
        name="Escort Armor Plating",
        slot="hull",
        effect="Armor-focused Escort plating scaling mitigation bonuses.",
        level_cap=15,
        upgrade_axes=('armor',),
        curves={
            "armor": _linear(4.25, 0.425),
            "acceleration": _linear(-0.2, 0.0),
            "turn_accel": _linear(-0.25, 0.0),
            "durability": _linear(18000.0, 0.0),
        },
        steps=_hull_steps(1275.0, 270.0),
    ),
    "escort_ht_plating": EquipmentUpgradeSpec(
        item_id="escort_ht_plating",
        name="Escort HT Plating",
        slot="hull",
        effect="Heavy-tuned Escort plating scaling critical defense.",
        level_cap=15,
        upgrade_axes=('critical_defense',),
        curves={
            "critical_defense": _linear(7.5, 0.75),
    ...
    "escort_ht_hull_plating": EquipmentUpgradeSpec(
        item_id="escort_ht_hull_plating",
        name="Escort HT Hull Plating",
        slot="hull",
        effect="Heavy-tuned hybrid plating scaling hull points and crit defense.",
        level_cap=15,
        upgrade_axes=('critical_defense', 'hull_hp'),
        curves={
            "critical_defense": _linear(2.5, 0.25),
            "hull_hp": _linear(110.0, 11.0),
            "acceleration": _linear(-0.07, 0.0),
            "turn_accel": _linear(-0.33, 0.0),
            "durability": _linear(18000.0, 0.0),
        },
    ...
    "escort_ht_armor_plating": EquipmentUpgradeSpec(
        item_id="escort_ht_armor_plating",
        name="Escort HT Armor Plating",
        slot="hull",
        effect="Heavy-tuned armor blend scaling mitigation and crit defense.",
        level_cap=15,
        upgrade_axes=('armor', 'critical_defense'),
        curves={
            "armor": _linear(2.83, 0.2835714285714286),
            "critical_defense": _linear(2.5, 0.25),
            "acceleration": _linear(-0.13, 0.0),
            "turn_accel": _linear(-0.17, 0.0),
            "durability": _linear(18000.0, 0.0),
        },
        steps=_hull_steps(1275.0, 270.0),
    ),
    "escort_ht_composite_plating": EquipmentUpgradeSpec(
        item_id="escort_ht_composite_plating",
        name="Escort HT Composite Plating",
        slot="hull",
        effect="Heavy-tuned composite scaling armor, hull, and crit defense.",
        level_cap=15,
        upgrade_axes=('armor', 'critical_defense', 'hull_hp'),
        curves={
            "armor": _linear(1.7, 0.17),
            "critical_defense": _linear(1.5, 0.15),
            "hull_hp": _linear(66.0, 6.6),
            "acceleration": _linear(-0.12, 0.0),
            "turn_accel": _linear(-0.3, 0.0),
            "durability": _linear(18000.0, 0.0),
        },
        steps=_hull_steps(1275.0, 270.0),
    ),
    "escort_system_redundancy": EquipmentUpgradeSpec(
        item_id="escort_system_redundancy",
        name="Escort System Redundancy",
        slot="hull",
        effect="Escort regeneration module scaling hull recovery per level.",
        level_cap=15,
        upgrade_axes=('hull_recovery',),
        curves={
            "hull_recovery": _linear(1.5, 0.15),
            "durability": _linear(18000.0, 0.0),
        },
        steps=_hull_steps(1125.0, 225.0),
    ),
    "escort_damage_control": EquipmentUpgradeSpec(
        item_id="escort_damage_control",
        name="Escort Damage Control",
        slot="hull",
        effect="Active Escort repair package scaling burst restoration.",
        level_cap=15,
        upgrade_axes=('hull_restore',),
        curves={
            "hull_restore": _linear(150.0, 15.0),
            "reload": _linear(30.0, 0.0),
            "power": _linear(100.0, 0.0),
            "durability": _linear(18000.0, 0.0),
        },
        steps=_hull_steps(1350.0, 285.0),
    ),
    ...
    "plasma_orb_launcher": EquipmentUpgradeSpec(
        item_id="plasma_orb_launcher",
        name="P-01 'Plasma Orb Launcher'",
        slot="weapon",
        effect="Thorim's plasma siege engine concentrating output and trimming charge time.",
        level_cap=15,
        upgrade_axes=("damage", "reload"),
        curves={
            "damage_min": _linear(1000.0, 85.71428571428571),
            "damage_max": _linear(1000.0, 85.71428571428571),
            "armor_piercing": _linear(55.0, 0.0),
            "range_min": _linear(1200.0, 0.0),
            "range_max": _linear(4000.0, 0.0),
            "optimal_range": _linear(3600.0, 0.0),
            "accuracy": _linear(150.0, 0.0),
            "critical_offense": _linear(120.0, 0.0),
            "reload": _linear(60.0, -2.142857142857143),
