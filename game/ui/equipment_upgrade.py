...
EQUIPMENT_UPGRADE_SPECS: Dict[str, EquipmentUpgradeSpec] = {
    ...
    "light_drive_overcharger": EquipmentUpgradeSpec(
        ...
        slot="engine",
        effect="Flat speed booster scaling cruise and boost velocity.",
        level_cap=15,
    ...
    "light_turbo_boosters": EquipmentUpgradeSpec(
        ...
        slot="engine",
        effect="Acceleration shunts scaling linear acceleration and boost speed.",
        level_cap=15,
    ...
    "light_gyro_stabilization": EquipmentUpgradeSpec(
        ...
        slot="engine",
        effect="Gyro package scaling turn rate and acceleration.",
        level_cap=15,
    ...
    "light_rcs_ducting": EquipmentUpgradeSpec(
        ...
        slot="engine",
        effect="Avoidance ducting scaling hit avoidance over levels.",
        level_cap=15,
    ...
    "t8_drive_turbo_charger": EquipmentUpgradeSpec(
        ...
        slot="engine",
        effect="Raven turbo charger scaling percentage speed and boost bonuses.",
        level_cap=15,
    ...
    "fog_gyro_stabilization": EquipmentUpgradeSpec(
        ...
        slot="engine",
        effect="Raven gyro suite scaling percentage turn rate and acceleration.",
        level_cap=15,
    ...
    "translation_rcs_thrusters": EquipmentUpgradeSpec(
        ...
        slot="engine",
        effect="Raven RCS package scaling turn rate and strafe speed percentages.",
        level_cap=15,
    ...
    "t15_pulsed_plasma_thruster": EquipmentUpgradeSpec(
        ...
        slot="engine",
        effect="Raven booster scaling percentage boost speed and acceleration.",
        level_cap=15,
    ...
    "coupled_rcs_ducting": EquipmentUpgradeSpec(
        ...
        slot="engine",
        effect="Raven defensive ducting scaling avoidance percentage.",
        level_cap=15,
    ...
    "fbs_12_engine_overload": EquipmentUpgradeSpec(
        ...
        slot="engine",
        effect="Rhino overdrive scaling active duration for its boost surge.",
        level_cap=15,
