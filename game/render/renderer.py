...
def _build_glaive_wireframe() -> list[tuple[Vector3, Vector3]]:
    ...
    stern_upper_loop = [
        Vector3(0.0, 1.2, -2.2),
        Vector3(1.88, 1.1, -2.6),
        Vector3(2.33, 1.0, -3.4),
        Vector3(1.73, 0.9, -4.1),
        Vector3(0.0, 0.9, -4.2),
        Vector3(-1.73, 0.9, -4.1),
        Vector3(-2.33, 1.0, -3.4),
        Vector3(-1.88, 1.1, -2.6),
    ...
    stern_lower_loop = [
        Vector3(0.0, -0.8, -2.4),
        Vector3(1.73, -0.7, -2.8),
        Vector3(2.18, -0.6, -3.6),
        Vector3(1.58, -0.5, -4.2),
        Vector3(0.0, -0.5, -4.2),
        Vector3(-1.58, -0.5, -4.2),
        Vector3(-2.18, -0.6, -3.6),
        Vector3(-1.73, -0.7, -2.8),
    ...
    module_ridges = [
        Vector3(-0.94, 1.5, 0.9),
        Vector3(-1.01, 1.4, -0.1),
        Vector3(-1.01, 1.4, -1.2),
        Vector3(-0.9, 1.5, -2.0),
    ]
    ...
    strake_points = [
        Vector3(-2.33, 1.8, 3.1),
        Vector3(-2.48, 1.5, 2.2),
        Vector3(-2.33, 1.2, 1.0),
    ]
